# Generated by Django 3.2 on 2023-09-16 13:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(blank=True, null=True, validators=[config.validators.cooking_time_validator], verbose_name='Время приготовления (в минутах)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField(validators=[config.validators.amount_validator], verbose_name='Количество ингредиентов')),
